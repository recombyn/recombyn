<p align="center">
  <img src="docs/assets/readme-hero.jpg" alt="recombyn — オープンソースのキャンバス + AI Design Agent" width="920" />
</p>
...
- **組み合わせ可能** — インフラ seed + プロンプトパック + `apps/api/data/public/` の **コア Agent skills**
