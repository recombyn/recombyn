...
def admin_extract_sample_tokens(
    ...
    from app.services.design.aesthetics.token_extract import extract_design_tokens_meta
...
def admin_quality_samples_coverage(
    ...
    from app.services.design.admin.quality_sample_store import count_ready_good_by_scene
...
def admin_quality_sample_thumb(
    ...
    from app.services.design.admin.quality_sample_store import get_quality_sample_thumb
...
def admin_quality_sample_from_task(
    ...
    from app.services.design.aesthetics.from_task import sample_from_task
...
def admin_design_task_preview(
    ...
    from app.services.design.aesthetics.from_task import get_task_preview
...
def admin_aesthetics_settings(
    ...
    from app.services.design.aesthetics.calibrate import aesthetics_settings
    from app.services.design.aesthetics.clip_encoder import clip_status
...
def admin_set_aesthetics_threshold(
    ...
    from app.services.design.aesthetics.calibrate import aesthetics_settings, set_threshold
...
def admin_aesthetics_calibrate(
    ...
    from app.services.design.aesthetics.calibrate import calibrate_threshold
