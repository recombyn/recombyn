...
class User(SQLModel, table=True):
    ...
    avatar: Optional[str] = Field(default=None, sa_column=Column(Text, nullable=True))
    default_avatar: Optional[str] = Field(default=None, sa_column=Column(Text, nullable=True))
...
class PlazaSubmission(SQLModel, table=True):
    ...
    author_avatar: Optional[str] = Field(default=None, sa_column=Column(Text, nullable=True))
    ...
    reject_reason: Optional[str] = Field(default=None, sa_column=Column(Text, nullable=True))
...
class UserFollow(SQLModel, table=True):
    ...
    followee_avatar: Optional[str] = Field(default=None, sa_column=Column(Text, nullable=True))
    created_at: float = Field(default=0.0)
...
class DesignStageReview(SQLModel, table=True):
    ...
    preview_svg: Optional[str] = Field(default=None, sa_column=Column(Text, nullable=True))
...
class DesignTask(SQLModel, table=True):
    ...
    actual_models: Optional[str] = Field(default=None, sa_column=Column(Text, nullable=True))
...
class DesignLayerLock(SQLModel, table=True):
    ...
    allowed_skills: Optional[str] = Field(default=None, sa_column=Column(Text, nullable=True))
    forbidden_attrs: Optional[str] = Field(default=None, sa_column=Column(Text, nullable=True))
    created_at: float = Field(default=0.0)
    updated_at: float = Field(default=0.0)
...
class DesignTokenPack(SQLModel, table=True):
    ...
    tokens_json: str = Field(default="", sa_column=Column(Text, nullable=False))
...
class DocumentShare(SQLModel, table=True):
    ...
    editor_user_ids: Optional[str] = Field(default=None, sa_column=Column(Text, nullable=True))
    viewer_user_ids: Optional[str] = Field(default=None, sa_column=Column(Text, nullable=True))
...
class DesignSkillGroup(SQLModel, table=True):
    ...
    id: Optional[int] = Field(default=None, primary_key=True)
    name: str = Field(max_length=128)
    skill_ids: str = Field(default="[]", sa_column=Column(Text, nullable=False))
    scenes: str = Field(default="all", max_length=128)
...
class DesignExecuteFlow(SQLModel, table=True):
    ...
    skill_ids: str = Field(default="[]", sa_column=Column(Text, nullable=False))
    force_validate_flags: Optional[str] = Field(default=None, sa_column=Column(Text, nullable=True))
    step_token_caps: Optional[str] = Field(default=None, sa_column=Column(Text, nullable=True))
...
class AgentKgTriple(SQLModel, table=True):
    ...
    object: str = Field(default="", sa_column=Column(Text, nullable=False))
...
class AgentEpisode(SQLModel, table=True):
    ...
    actions_json: Optional[str] = Field(default=None, sa_column=Column(Text, nullable=True))
    observe_json: Optional[str] = Field(default=None, sa_column=Column(Text, nullable=True))
...
class DesignOptimizePatch(SQLModel, table=True):
    ...
    patch_json: str = Field(default="{}", sa_column=Column(Text, nullable=False))
    rationale: Optional[str] = Field(default=None, sa_column=Column(Text, nullable=True))
    flags_json: Optional[str] = Field(default=None, sa_column=Column(Text, nullable=True))
...
class UserByokProvider(SQLModel, table=True):
    ...
    user_id: str = Field(index=True, max_length=64)
    name: str = Field(max_length=128)
    website: Optional[str] = Field(default=None, sa_column=Column(Text, nullable=True))
    ...
    api_key_cipher: str = Field(default="", sa_column=Column(Text, nullable=False))
