...
- How to build (layout, type, hero, clear-board, brush, motion, …): follow **SKILL_DETAILS** for skills already loaded this turn.
- Do not invent skill keys; do not paste long playbooks into reply or thought.
