...
from services.agent_memory.episodes import list_recent_episodes
...
class MemoryService:
    def load(
        ...
        *,
        ...
        from services.agent_memory.kg import retrieve_triples
        ...
        from services.agent_memory.short_term import prepare_dialogue_layers
    ...
    def build_run_patch(
        ...
        *,
        ...
        from services.agent_memory.short_term import update_dialogue_after_run
