...
from services.design.ops.tool_ops_contract import format_canvas_tools_details
from services.design.prompts.knowledge_store import format_knowledge_details
