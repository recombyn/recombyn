...
from services.llm import PROVIDER_BASE_URLS, _api_key_for
from services.llm.catalog_store import list_admin_models, upsert_model
from services.llm.image_price import (
...
def sync_ark_catalog_prices(*, only_empty: bool = False) -> dict[str, Any]:
    ...
    """
    from services.llm.catalog_store import apply_ark_reference_prices
