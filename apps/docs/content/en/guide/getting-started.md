...
Your first sign-in creates an account. Chat, Agent, and image generation share one unified credit balance.
...
| Editor canvas | Infinite canvas + multiple artboards, manual edits, and image tools |
| Agent panel (right) | Agent / Ask / Image modes; optional Auto routing |
| Account | Plans, credits, profile, and notifications |
...
- The free tier includes daily Auto trials; see Plans and card-key redemption for more quota; ledger under Usage & billing.
- Work syncs to the cloud; leaving the editor auto-saves the document and cover.
- Account **Notices** covers product announcements.
