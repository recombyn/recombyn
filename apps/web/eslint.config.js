...
/**
 * Lightweight ESLint — a11y + React hooks as warn.
...
export default [
  ...
  js.configs.recommended,
  {
    ...
    rules: {
      // TS handles these; keep ESLint quiet on typed code.
      'no-undef': 'off',
      'no-unused-vars': 'off',
      'no-redeclare': 'off',
      ...
      // a11y — warn-only until call sites are cleaned up
  ...
  // Pointer-drag surfaces (color pickers, popovers) — not keyboard-primary widgets.
  {
    files: [
