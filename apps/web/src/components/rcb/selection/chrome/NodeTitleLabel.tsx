...
function NodeTitleLabel({
  ...
  const html = nodeTitleHtmlAnchor(plate, z, angle);
      ...
      >
        ...
        >
          <div
            ...
            className={cn(
              'pointer-events-auto absolute flex min-w-0 items-center justify-start gap-1 overflow-hidden font-medium select-none',
