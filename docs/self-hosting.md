...
- **Hosted / managed service** of Recombyn (or a substantially similar platform) to third parties — paid or free — requires **commercial / enterprise authorization** (`licensing@recombyn.com`).
